...
int main()
{
	...
	*/
	...
	glm::vec3 color = glm::vec3(0.9f,0.9f,0.9f); //inicializar Color para enviar a variable Uniform;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Mover todo el modelo (test)
		//model = glm::translate(model, glm::vec3((mainWindow.getarticulacion6())*-0.1f, 0.0f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getart11()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::scale(model, glm::vec3(1.05f, 2.45f, 1.05f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		//articulacion 2
		model = modelaux2;
		...
		model = glm::rotate(model, glm::radians(mainWindow.getart12()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		sp.render();
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-0.5f, -0.95f, 0.0f));
		model = glm::rotate(model, glm::radians(-25.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.05f, 1.95f, 1.05f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		model = glm::translate(model, glm::vec3(0.35f, -0.5f, 0.0f));
		model = glm::scale(model, glm::vec3(1.45f, 0.25f, 1.05f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		model = glm::rotate(model, glm::radians(25.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getart13()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		...
		model = glm::translate(model, glm::vec3(0.0f, -2.15f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getart14()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		...
		//cabeza
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.75f, 1.05f, 0.0f));
		...
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(2.05f, 2.15f, 2.05f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		//orejas
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, 2.05f, 1.5f));
		model = glm::scale(model, glm::vec3(1.05f, 2.15f, 1.05f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 1.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getart15()), glm::vec3(0.0f, 1.0f, 1.0f));
		...
		model = glm::scale(model, glm::vec3(1.05f, 2.15f, 1.05f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 1.0f, -1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getart16()), glm::vec3(0.0f, 1.0f, -1.0f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(-1.0f, -1.0f, 0.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.0f, 0.0f);
		...
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -2.15f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(-1.0f, -1.0f, 0.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(0.55, 0.55f, 0.55f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
