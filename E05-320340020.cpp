...
int main()
{
	...
	Goddard_Body = Model();
	Goddard_Body.LoadModel("Models/goddard_body.obj");
	Goddard_Mand = Model();
	Goddard_Mand.LoadModel("Models/goddard_mand.obj");
	Goddard_PT = Model();
	Goddard_PT.LoadModel("Models/goddard_PT.obj");
	Goddard_PD = Model();
	Goddard_PD.LoadModel("Models/goddard_PD.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Goddard_Body.RenderModel();//modificar por el modelo sin las 4 patas y sin cola

		color = glm::vec3(0.0f, 0.0f, 1.0f);
		model = glm::translate(model, glm::vec3(2.75f, 1.35f, 0.15f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Goddard_Mand.RenderModel();//modificar por el modelo sin las 4 patas y sin cola
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Goddard_PT.RenderModel();//modificar por el modelo sin las 4 patas y sin cola
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Goddard_PD.RenderModel();//modificar por el modelo sin las 4 patas y sin cola
		color = glm::vec3(0.0f, 0.0f, 1.0f);
