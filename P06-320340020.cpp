...
void CrearOctaedro()
{
	...
	GLfloat octa_vertices[] = {
		// x      y      z         S     T          NX    NY    NZ
		// 1 
		0.0f,  a,     0.0f,     0.32f,  0.2f,      n,    n,    n,   
		a,     0.0f,  0.0f,     0.01f,  0.01f,      n,    n,    n,  
		0.0f,  0.0f,  a,        0.01f,  0.39f,      n,    n,    n,   

		// 4 
		0.0f,  a,     0.0f,     0.34f,	0.2f,      n,    n,   -n,
		0.0f,  0.0f, -a,        0.65f,  0.385f,      n,    n,   -n, 
		a,     0.0f,  0.0f,     0.65f,  0.015f,      n,    n,   -n, 

		// 3 
		0.0f,  a,     0.0f,     0.34f,  0.205f,     -n,    n,   -n, 
	   -a,     0.0f,  0.0f,     0.34f,  0.59f,     -n,    n,   -n, 
		0.0f,  0.0f, -a,        0.65f,  0.395f,     -n,    n,   -n, 

		// 2
		0.0f,  a,     0.0f,     0.33f,  0.205f,     -n,    n,    n, 
		0.0f,  0.0f,  a,        0.02f,  0.41f,     -n,    n,    n, 
	   -a,     0.0f,  0.0f,     0.32f,  0.59f,     -n,    n,    n, 

	   // 8
	   0.0f, -a,     0.0f,     0.67f,  0.8f,      n,   -n,    n,  
	   0.0f,  0.0f,  a,        0.99f,  0.99f,      n,   -n,    n,  
	   a,     0.0f,  0.0f,     0.99f,  0.61f,      n,   -n,    n,  

	   // 7
	   0.0f, -a,     0.0f,     0.67f,  0.79f,      n,   -n,   -n,  
	   a,     0.0f,  0.0f,     0.98f,  0.59f,      n,   -n,   -n,  
	   0.0f,  0.0f, -a,        0.67f,  0.43f,      n,   -n,   -n,  

	   // 6 
	   0.0f, -a,     0.0f,     0.645f,  0.785f,     -n,   -n,   -n,  
	   0.0f,  0.0f, -a,        0.65f,  0.41f,     -n,   -n,   -n,  
	  -a,     0.0f,  0.0f,     0.34f,  0.6f,     -n,   -n,   -n,  

	  // 5
	  0.0f, -a,     0.0f,     0.63f,  0.785f,     -n,   -n,    n,   
	 -a,     0.0f,  0.0f,     0.34f,  0.61f,     -n,   -n,    n,   
	  0.0f,  0.0f,  a,        0.34f,  0.99f,     -n,   -n,    n,   
	};

	Mesh* octaedro = new Mesh();
	// 192 floats, 24 índices
