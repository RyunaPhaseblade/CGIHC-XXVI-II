...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(5.5f, 2.5f, 4.0f));
		...
		//rueda 1
		model = modelaux2;
		model = glm::translate(model, glm::vec3(1.75f, -1.75f, 2.45f));
		...
		//Canasta
		model = modelaux;
		model = glm::translate(model, glm::vec3(-0.85f, -0.45f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.75f, 2.5f, 1.75f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
